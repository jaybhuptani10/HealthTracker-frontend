  ...
  const notifications = [
    {
      ...
      message: "Congratulations! You've reached your daily target of 2000 calories.",
      time: "Today, 8:43 PM",
      read: false,
      priority: "high"
    },
    {
      ...
      message: "Your calorie intake has been 15% below your target for the past 7 days.",
    ...
    },
    {
      ...
      message: "You're currently at 75% of your daily protein goal. Consider adding a protein-rich snack.",
    ...
    },
    {
      ...
      message: "You're on track to meet your monthly calorie average goal of 2000 kcal.",
      time: "Feb 25, 3:15 PM",
      read: false,
      priority: "medium"
    },
    ...
    },
    {
      ...
      message: "You've only logged 3 glasses of water today. Remember to stay hydrated!",
      time: "Feb 23, 2:45 PM",
      read: true,
      priority: "low"
    }
      ...
      <div className="mb-6">
        <div className="flex space-x-3">
          <button 
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${filter === "all" ? "bg-blue-500 text-white" : "bg-white hover:bg-gray-100"}`}
          >
            All
          </button>
          <button 
            onClick={() => setFilter("unread")}
            className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${filter === "unread" ? "bg-blue-500 text-white" : "bg-white hover:bg-gray-100"}`}
          >
            Unread
          </button>
          <button 
            onClick={() => setFilter("high")}
            className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${filter === "high" ? "bg-blue-500 text-white" : "bg-white hover:bg-gray-100"}`}
          >
            High Priority
          </button>
        </div>
      ...
      <div className="space-y-4">
        {filteredNotifications.length > 0 ? (
          filteredNotifications.map((notification) => (
            <Card key={notification.id} className={`${notification.read ? 'bg-white' : 'bg-blue-50'} hover:shadow-lg transition-shadow`}>
              <CardContent>
                <div className="flex items-start">
                  <div className={`flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center ${getPriorityColor(notification.priority)} text-white text-xl mr-4`}>
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-md text-gray-600 mt-2">{notification.message}</p>
                  </div>
